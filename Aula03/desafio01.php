    ...
    <div class="container mt-4">
        <form action="" method="post" class="form-control p-3" id="frmNotas">
            <div class="row">
                ...
                <hr>
                <div class="col-sm-4">
                    <p><input type="text" placeholder="N1" name="txtN1" id="txtN1" class="form-control notas"></p>
                    <p><input type="text" placeholder="N2" name="txtN2" id="txtN2" class="form-control notas"></p>
                    <p><input type="text" placeholder="N3" name="txtN3" id="txtN3" class="form-control notas"></p>
                    <p><input type="text" placeholder="N4" name="txtN4" id="txtN4" class="form-control notas"></p>
